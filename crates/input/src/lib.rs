...
use boxdesk_krun::{AbsInfo, InputDevice};
pub use boxdesk_krun::{EV_ABS, EV_KEY, EV_REL, EV_SYN, InputEvent};
...
pub fn keyboard() -> InputDevice {
    InputDevice::new("boxdesk keyboard")
        .serial("boxdesk-kbd")
...
pub fn pointer() -> InputDevice {
    InputDevice::new("boxdesk pointer")
        .serial("boxdesk-ptr")
