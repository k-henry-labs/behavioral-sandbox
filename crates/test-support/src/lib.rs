...
pub fn hypervisor_unusable() -> Option<String> {
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        // does not carry `com.apple.security.hypervisor`, and cargo rewrites `target/debug/boxdesk`
        ...
        Some(
            "a VM booted from a test needs an entitled `boxdesk`, and cargo drops the signature \
