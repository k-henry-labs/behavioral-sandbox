...
https://github.com/kendricklawton/boxdesk/security/advisories/new
...
<!--
The five rules are in docs/architecture.md. Name the one this change is closest to and why it holds,
...
- [ ] A change to the pinned surface (`boxdesk-channel`'s wire framing, or `boxdesk-supervisor`'s
